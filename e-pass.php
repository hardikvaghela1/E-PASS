...
<body>
    ...
    <main>
        ...
        <section id="signup">
            ...
            <form id="signupForm" action="e-pass.php" method="post">
                ...
                <button onclick="window.open('login.php','_blank')" type="submit" id="signup-1" name="sb">Sign Up </button>     
            </form>
    ...
    <script>
        document.getElementById('signupform').addEventListener('submit',function(event){
            ...
            // check if the userame input is empty
            var fullname = document.getElementById('fullname').value.trim();
            if (fullname === ''){
                alert('fullname cannot be blank');
                return;
            }
            // If input is not empty , submit the form programmatically
            this.submit();
        });
